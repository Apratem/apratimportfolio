$(window).on('load',function(){
  gsap.to('#loader', 1, { opacity: 0, onComplete: function() {
...
$(function(){
  // Function to toggle color changer panel
  $('.color-panel').on("click", function(e) {
    e.stopPropagation(); // Prevent event bubbling
    $('.color-changer').toggleClass('color-changer-active');
});

// Function to close color changer panel when clicking outside
$(document).on("click", function(e) {
    if (!$(e.target).closest('.color-panel').length && !$(e.target).closest('.color-changer').length) {
